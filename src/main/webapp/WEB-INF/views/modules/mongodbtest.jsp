...
<link rel="stylesheet" href="<%= basePath %>/common/css/bootstrap/bootstrap.min.css">
<link rel="stylesheet" href="<%= basePath %>/common/css/jquery.bootgrid.min.css">
<script src="<%= basePath %>/common/js/bootstrap/bootstrap.min.js"></script>
<script src="<%= basePath %>/common/js/jquery.bootgrid.min.js"></script>
  </head>
  <body>
    <div class="container">
  	<div class="row">
